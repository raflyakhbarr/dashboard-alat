...
async function submitPenindaklanjut(formData: FormData) {
  ...
  if (!session || session.role !== 'peralatan_terminal') {
    redirect('/login');
  }
  ...
  try {
    ...
    redirect('/peralatan_terminal/penindak-lanjut?success=true');
  } catch (error: any) {
    console.error('Error creating penindaklanjut:', error);
    redirect('/peralatan_terminal/penindak-lanjut?error=true');
  }
}
...
export default async function PenindakLanjutPage({
  ...
  const laporanList = await getLaporanByPenindakLanjut('peralatan_terminal');
            ...
            <>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Daftar laporan kerusakan yang ditugaskan ke tim Peralatan Terminal
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="space-y-4">
                      {pendingReports.map((laporan) => (
                        ...
                        >
                          ...
                          <Link href={`/peralatan_terminal/penindak-lanjut?laporan_id=${laporan.id}`}>
                            <Button>
                ...
                <CardContent>
                  ...
                  <form action={submitPenindaklanjut} className="space-y-6">
                    ...
                    <div className="flex gap-4">
                      ...
                      <Link href="/peralatan_terminal/penindak-lanjut">
